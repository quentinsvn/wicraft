...
{if isset($BANNER_IMAGE)}
    <div class="banner">
        ...
        <h1>{foreach from=$BREADCRUMBS item=breadcrumb}{if isset($breadcrumb.active)}{$breadcrumb.forum_title}{/if}{/foreach}</h1>
    </div>
{/if}
    ...
    <div class="row">
        <div class="col-12 col-md-12">
            ...
            <span class="float-md-right">
                ...
                {if isset($CAN_REPLY)}
                <div class="btn-group">
                    <a{if isset($LOCKED) && !isset($CAN_MODERATE)} disabled="disabled" {else} href="#reply_section" {/if} style="vertical-align:baseline;" class="btn btn-{if isset($LOCKED) && !isset($CAN_MODERATE)}warning disabled{else}primary{/if}">{if isset($LOCKED) && !isset($CAN_MODERATE)}
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <center>
                                ...
                                <span rel="tooltip" data-toggle="hover" data-original-title="{$reply.last_seen_full}">{$reply.last_seen}</span><br />
                        ...
                        <div class="col-md-9">
                            ...
                            &raquo; <span data-toggle="tooltip" data-trigger="hover" data-original-title="{$reply.post_date}">{$reply.post_date_rough}</span>
                            ...
                            <span class="float-md-right">
                                ...
                                <a class="btn btn-secondary btn-sm" data-toggle="tooltip" data-trigger="hover" data-original-title="{$reply.buttons.edit.TEXT}" href="{$reply.buttons.edit.URL}"><i class="fa fa-pencil-alt fa-fw" aria-hidden="true"></i></a>
                                {/if}
                            ...
                            <small><span rel="tooltip" data-toggle="hover" data-original-title="{$reply.edited_full}">{$reply.edited}</span>
                            </small>{/if}
                            {if count($reply.post_reactions)}
                            <span class="float-md-right" data-toggle="modal" data-target="#reactions{$reply.id}Modal">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <a style="{$user.style}" href="{$user.profile}"><img src="{$user.avatar}" class="rounded" style="height:25px;width:25px;" alt="{$user.username}" /> {$user.nickname}
                            </a>
                            <br />
                            {/foreach}
