...
class WiCraftTemplate extends TemplateBase {
	...
	public function __construct($cache, $smarty, $language, $user, $pages){
		...
		parent::__construct(
			'WiCraft',  // Template name
			'2.0.0-pr7',  // Template version
			'2.0.0-pr7',  // Nameless version template is made for
			'<a href="https://www.mc-market.org/members/252214/" target="_blank">Volcanet</a>'  // Author, you can use HTML here
		);
		...
		$this->addCSSFiles(array(
			(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/templates/WiCraft/css/' . Output::getClean($theme) . '.min.css' => array(),
			(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/core/assets/css/custom.css' => array(),
			(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/templates/WiCraft/css/style.css' => array(),
		...
		$this->addJSFiles(array(
			(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/templates/WiCraft/js/popper.min.js' => array(),
			...
			'https://code.jquery.com/jquery-3.5.1.slim.min.js' => array('integrity' => 'sha384-DfXdz2htPH0lsSSs5nCTpuj/zy4C+OGpamoFVy38MVBnE+IbbVYUew+OrCXaRkfj', 'crossorigin' => 'anonymous'),
	...
	public function onPageLoad(){
		...
		if(defined('PAGE')){
			if(PAGE == 'cc_messaging'){ // cc_messaging = UserCP -> Messaging
				$this->addCSSFiles(array(
					(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/templates/WiCraft/css/bootstrap-tokenfield.min.css' => array(),
					(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/core/assets/css/jquery-ui.min.css' => array()
				));

				$this->addJSFiles(array(
					(defined('CONFIG_PATH') ? CONFIG_PATH : '') . '/custom/templates/WiCraft/js/bootstrap-tokenfield.min.js' => array(),
...
$template = new WiCraftTemplate($cache, $smarty, $language, $user, $pages);
