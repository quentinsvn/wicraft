...
<div class="jumbotron" style="background-image:url('{$BANNER}');background-size:cover; border-radius: 0;">
    <div class="row">
        <div class="col-md-8">
            <h2>
                <img style="height:60px;width:60px;" src="{$AVATAR}" />
...
<div class="pr-3 pl-3 pr-md-5 pl-md-5 pb-3">
